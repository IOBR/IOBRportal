...
This module provides a **database-driven workflow** for **Immunotherapy Cohorts analysis** using cloud/DuckDB data, including **signature scoring / TME deconvolution results** and **downstream analysis** (visualization, correlation, and group comparison).
...
- This workflow is designed for **Immunotherapy Cohorts cloud/database data** (DuckDB-backed), so downstream modules mainly use the selected dataset from Part 1.
...
### Recommended Order
1. Data Selection (choose cohort and data type)
2. TME Cluster
3. Visualization / Correlation / Group Comparison
