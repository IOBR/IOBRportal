...
This module provides a **database-driven workflow** for **Cancer Cohorts analysis** using cloud/DuckDB data, including **signature scoring / TME deconvolution results** and **downstream analysis** (visualization, correlation, and group comparison).
...
- This workflow is designed for **Cancer Cohorts cloud/database data** (DuckDB-backed), so downstream modules mainly use the selected dataset from Part 1.
