...
This module provides a **database-driven workflow** for **Other Cohorts (CPTAC/TARGET) analysis** using cloud/DuckDB data, including **signature scoring / TME deconvolution results** and **downstream analysis** (visualization, survival, correlation, and group comparison).
...
- This workflow is designed for **Other Cohorts cloud/database data** (DuckDB-backed), so downstream modules mainly use the selected dataset from Part 1.
